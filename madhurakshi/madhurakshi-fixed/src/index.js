...
// Strict limiter for order/payment endpoints — must be registered BEFORE the
// router so it fires first. Registering it after app.use('/api', routes) is
// too late; Express has already matched and run the handler by then.
